    ...
    <div className="bg-cover bg-center w-screen flex items-center justify-center pb-4">
      <div className="min-h-screen w-full flex justify-center ">
        <div className="mt-12 w-full px-5">
          ...
          <div className="grid container mx-auto py-12 md:py-20 lg:py-24 xl:py-36 grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 px-6 sm:px-12 md:px-24 xl:px-44">
