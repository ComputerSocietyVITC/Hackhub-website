...
const Sponsors = () => {
    return (
        <section className="relative w-full bg-center py-12 font-montserrat">
            <div className="w-full px-4 md:px-6">
                ...
                <div className="max-w-6xl mx-auto mb-24 text-center">
                    <p className="text-white text-lg sm:text-xl leading-relaxed">
                        ...
                        competition—it’s a celebration of innovation,
                        collaboration, and technological advancement.
                    </p>
                    <p className="text-white text-lg sm:text-xl leading-relaxed mt-4">
                        As a partner, you’ll enjoy unparalleled visibility among
                        a vibrant, tech-oriented audience and have the chance to
                        connect with some of the brightest up-and-coming
                        talents. Showcase your brand as a thought leader in the
                        tech community, contribute to shaping the future of
                        innovation, and align with a mission that empowers the
                        next generation of changemakers.
                    </p>
                    <p className="text-white text-lg sm:text-xl leading-relaxed mt-4">
                        Let’s drive change together. Partner with HackHub and
                        make a lasting impact on the future of technology and
                        innovation.
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-10">
                    ...
                    <Button
                        text="Brochure"
                        href="/Hackhub_Broucher_gallery.pdf"
                    />
                </div>
            </div>
        </section>
