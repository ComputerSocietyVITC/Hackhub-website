...
const PrevEditions = () => {
    ...
    return (
        <div className="bg-[#0D1117] bg-center w-screen flex items-center justify-center pb-4">
            <div className="w-full flex justify-center items-center">
                <div className="mt-12 w-full px-5">
                    ...
                    {isDesktop ? (
                        ...
                        <MobileCarousel images={images} setImages={setImages} />
                    )}
                </div>
            </div>
        </div>
...
const MobileCarousel: React.FC<ImageGridProps> = ({ images }) => {
    ...
    return (
        <div
            className="grid w-full mx-auto h-[320px] grid-cols-5 grid-rows-5 gap-3 transition-all duration-300"
            ref={carouselRef}
...
const ImageGrid: React.FC<ImageGridProps> = ({ images }) => {
    ...
    return (
        <div
            className="grid w-full max-w-[1400px] mx-auto h-[430px] grid-cols-5 grid-rows-6 gap-5 mt-[100px] transition-all"
            ref={carouselRef}
        >
            <div
                className="col-span-1 row-start-2 row-span-4 bg-slate-100 rounded-xl filter hover:filter-none transform hover:scale-105 transition bg-cover bg-center"
                style={{
                    backgroundImage: `url(${images[0]})`,
            ...
            ></div>
            <div
                className="col-span-1 col-start-2 row-start-1 row-span-2 bg-slate-800 rounded-xl filter hover:filter-none transform hover:scale-105 transition bg-cover bg-center"
                style={{
                    backgroundImage: `url(${images[1]})`,
            ...
            ></div>
            <div
                className="col-span-1 col-start-2 row-start-3 row-span-2 bg-slate-800 rounded-xl filter hover:filter-none transform hover:scale-105 transition bg-cover bg-center"
                style={{
                    backgroundImage: `url(${images[2]})`,
            ...
            ></div>
            <div
                className="col-span-1 col-start-2 row-start-5 row-span-2 bg-slate-800 rounded-xl filter hover:filter-none transform hover:scale-105 transition bg-cover bg-center"
                style={{
            ...
            ></div>
            <div
                className="col-span-2 col-start-3 row-start-1 row-span-6 bg-slate-800 rounded-xl filter hover:filter-none transform hover:scale-105 transition bg-cover bg-center"
                style={{
            ...
            ></div>
            <div
                className="col-span-1 row-start-2 row-span-4 bg-slate-800 rounded-xl filter hover:filter-none transform hover:scale-105 transition bg-cover bg-center"
                style={{
